...
export class ActionBox extends Component {
    ...
    constructFormJSON() {
        ...
        data['organisation'] = this.state.organisation;
        data['phone_number'] = this.state.phone_number;
        data['contactable'] = this.state.contactable;
        data['persistent'] = this.state.persistent;
    ...
    handleSubmit(event) {
        ...
        this.props.src.rest.post(this.props.src.domain + 'users/', toPost)
                    ...
                    <div className="new-action col-xs">
                        <div className="row inputs">
                            <div className=" col-xs-6">
                                ...
                                <input placeholder='Jackie' onChange={ (e) => this.handleSingleChange('fname', e.target.value)} name="fname"  />
                            </div>
                            <div className="m col-xs-6">
                                <div className="section-title">
                                    <p>Last Name</p>
                                </div>
                                <input placeholder='Chan' onChange={ (e) => this.handleSingleChange('lname',e.target.value )} name="lname"  />
                            </div>
                        </div>
                        <div className="row inputs">
                            <div className=" col-xs-6">
                                ...
                                <input placeholder='Manager' onChange={(e) => this.handleSingleChange('position', e.target.value)} name="fname" />
                            </div>
                            <div className="m col-xs-6">
                                <div className="section-title">
                                    <p>Phone Number</p>
                                </div>
                                <input placeholder='0778899337' onChange={(e) => this.handleSingleChange('phone_number', e.target.value)} name="lname" />
                            </div>
                        </div>
                        <div className="row inputs">
                            <div className=" col-xs-6">
                                ...
                                <ActionPerson
                                    ...
                                    onChangeForParent={this.handleSingleChange}
                                    debug={false} 
                                />
                            </div>
                            ...
                            <div className="col-xs-6">
                                ...
                                <input placeholder='Manager' onChange={(e) => this.handleSingleChange('email', e.target.value)} name="fname" type="email" placeholder="j.kirk@starfleet.org"  />
                        ...
                        <div className="remainingForm">
                            <div className="row inputs">
                                ...
                                <div className="m col-xs-3">
                                    <div className="section-title">
                                        <p>Contactable</p>
                                    </div>
                                    <div className="checkbox-wrapper">
                                        <Checkbox defaultCheck={this.state.contactable} id="contactable" onToggle={ (checkedState) => this.handleSingleChange('contactable', checkedState)} className="left-curve-border" />
                                    </div>
                                </div>
                                ...
                                <div className="m col-xs-3">
                                    ...
                                    <div className="checkbox-wrapper">
                                        <Checkbox defaultCheck={this.state.persistent} id="persistent" onToggle={ (checkedState) => this.handleSingleChange('persistent', checkedState)} className="left-curve-border" />
                                    </div>
                                </div>
                                ...
                                <div className="newUserForm">
                                    ...
                                    <textarea placeholder='This person has to be called maestro - maestro only!' onChange={ (e) => this.handleSingleChange('notes',e.target.value )} name={"notes"} className={"notes searchBox"} />
                                </div>
