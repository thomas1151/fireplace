...
import SingleDocument from './documents/Single';
...
export class Documents extends Component {
    ...
    componentDidMount() {
        ...
        let self = this;
        self.props.src.rest.get('documents/?page=1&limit=20')
    ...
    render() {
        titleGenerator("Documents", this.props.config)
                ...
                <React.Fragment>
                    ...
                    <Switch>
                        {this.props.isMobile ?
                            ...
                            <React.Fragment>
                                <Route path="/documents/:id/" render={routeProps => <SingleDocument
                                ...
                                <Route exact path="/documents" render={routeProps =>
                                    <DocumentInbox fetchingMore={this.state.fetchingMore} fetchMore={this.fetchMore} {...routeProps} getItemByProp={this.getItemByProp} src={this.props.src} config={this.props.config} items={this.state.items} isMobile={this.props.isMobile} />
                                } />
                            ...
                            :
                            <React.Fragment>
                                <Route path="/documents/:id/view" render={routeProps => <SingleDocument
                                ...
                                <Route exact path="/documents/:id" render={routeProps =>
                                    <DocumentInbox fetchingMore={this.state.fetchingMore} fetchMore={this.fetchMore} {...routeProps} getItemByProp={this.getItemByProp} src={this.props.src} config={this.props.config} items={this.state.items} isMobile={this.props.isMobile}>
                                ...
                                <Route exact path="/documents" render={routeProps =>
                                    <DocumentInbox fetchingMore={this.state.fetchingMore} fetchMore={this.fetchMore} {...routeProps} getItemByProp={this.getItemByProp} src={this.props.src} config={this.props.config} items={this.state.items} isMobile={this.props.isMobile}>
                                        ...
                                        <div className="invoice-inspection col-xs-8">
                                            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/paper-css/0.3.0/paper.css" />
                                            <Route exact path="/documents/:id" render={routeProps => <SingleDocument
