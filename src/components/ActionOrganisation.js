        ...
        return (
            ...
            <div className="address row">
                <div className="col-xs-6 address-1 input-wrap ">
                    <ActionPerson assigned={assignedVals.line1} value={'line1'}  id={'line1'} src={this.state.suggestData} debug={false} onFetchForParent={this.suggestData} onSelectedForParent={this.handleLocationAutofill} onChangeForParent={this.onChangeForParent} placeholder="Line 1"/>
                </div>

                <div className="col-xs-6 address-2 input-wrap">
                        <ActionPerson assigned={assignedVals.line2} value={'line2'} id={'line2'} src={this.state.suggestData} debug={false} onFetchForParent={this.suggestData}  onChangeForParent={this.onChangeForParent} placeholder="Line 2"/>
                </div>
                
                <div className="col-xs-6 address-3 input-wrap">
                        <ActionPerson assigned={assignedVals.line3} value={'line3'} id={'line3'} src={this.state.suggestData} debug={false} onFetchForParent={this.suggestData}  onChangeForParent={this.onChangeForParent} placeholder="Line 3"/>
                </div>
                
                <div className="col-xs-6 address-4 input-wrap">
                        <ActionPerson assigned={assignedVals.line4} value={'line4'} id={'line4'} src={this.state.suggestData} debug={false} onFetchForParent={this.suggestData}  onChangeForParent={this.onChangeForParent} placeholder="Line 4"/>
                </div>
                
                <div className="col-xs-6 address-postcode input-wrap">
                        <ActionPerson assigned={assignedVals.postcode} value={'postcode'} id={'postcode'} src={this.state.suggestData} debug={false} onFetchForParent={this.suggestData}   onChangeForParent={this.onChangeForParent} placeholder="Postcode"/>
                </div>
                {this.props.children}
